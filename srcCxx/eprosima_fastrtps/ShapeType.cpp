...
size_t ShapeType::getMaxCdrSerializedSize(size_t current_alignment)
{
    ...
    current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4) + COLOR_MAX_LENGTH + 1;
...
size_t ShapeType::getKeyMaxCdrSerializedSize(size_t current_alignment)
{
	size_t current_align = current_alignment;
     ...
     current_align += 4 + eprosima::fastcdr::Cdr::alignment(current_align, 4) + COLOR_MAX_LENGTH + 1;
